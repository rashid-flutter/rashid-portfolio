        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
"I'm a passionate Flutter Developer who loves building fast, smooth, and user-friendly apps for mobile and web. With experience in Firebase, REST APIs, and state management like Riverpod and Bloc, I focus on creating seamless experiences. Always eager to learn and improve, I enjoy turning ideas into functional, high-performance applications." 🚀            </p>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1qd62vXzr7sFMyxDfbq4N_HipaR6fx-zp/view?usp=drive_link" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
